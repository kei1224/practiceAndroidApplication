...
public class MysizeFragment extends Fragment {
    ...
    public void onResume() {
        ...
        EditText edText1 = getView().findViewById(R.id.editText1);
        if(neck != 0){
            edText1.setText(Integer.toString(neck));
        }
        EditText edText2 = getView().findViewById(R.id.editText2);
        if(sleeve != 0){
            edText2.setText(Integer.toString(sleeve));
        }
        EditText edText3 = getView().findViewById(R.id.editText3);
        if(waist != 0){
            edText3.setText(Integer.toString(waist));
        }
        EditText edText4 = getView().findViewById(R.id.editText4);
        if(insideLeg != 0){
